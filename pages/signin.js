...
function signin({ providers }) {
  return (
    <div className="h-screen w-screen flex items-center">
      <div className="flex max-w-xs w-full mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 sm:max-w-4xl">
        <img
          className="hidden object-cover sm:block sm:w-1/2"
          src="/auth_pic.jpg"
        ></img>

        <div className="w-full px-6 py-8 md:px-8 sm:w-1/2">
          <img
          ...
          <button
            ...
            className="flex items-center justify-center w-full mt-4 text-gray-600 transition-colors duration-200 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
          >
